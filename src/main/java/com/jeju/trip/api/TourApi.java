...
public class TourApi {
	...
	// 인증키
	String serviceKey = "%2BXrdOk7mPv%2BPXhjg5oUoWvrkM7OZ2WBVP%2F4X51U0AHYYPVw0oTJNp64Enk%2Fthp2SlnSHQln4fPGXWz1HfS6gjw%3D%3D";
	...
	try {																										/*관광정보조회 : areaBasedList*/
		...
		urlBuilder.append("&" + URLEncoder.encode("numOfRows","UTF-8") + "=" + URLEncoder.encode("400", "UTF-8")); /*한 페이지 결과수*/
    	...
    	for (int i = 0; i < parse_itemlist.size(); i++) { // 해당 JSONArray객체에 값을 차례대로 가져와서 읽습니다.
    		...
    		urlBuilder2.append("&" + URLEncoder.encode("numOfRows","UTF-8") + "=" + URLEncoder.encode("400", "UTF-8")); /*한 페이지 결과수*/
